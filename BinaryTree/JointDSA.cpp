...
void BinaryTreeStart(std::ifstream & file)
{
    //BinaryTree * binT;// = BinaryTree();
    binT = new BinaryTree();
    ...
    //font
    sf::Font font;
    if (!font.loadFromFile("C:\\Users\\Jeka\\CLionProjects\\LFPC\\BinaryTree\\font\\walk.ttf"))
    {
    ...
    //create Window
    sf::RenderWindow window(sf::VideoMode(1200, 750), "PBL");
